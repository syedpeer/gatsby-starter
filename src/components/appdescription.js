	...
	render() {
		return (
			<section>
				...
				<p>A demo of this starter can be found at <a href="//gatsby-starter.davesabine.com">gatsby-starter.davesabine.com</a> and the full source code is at <a href="//github.com/scrum-works/gatsby-starter">github.com/scrum-works/gatsby-starter</a>.</p>
			</section>
		)
	}
}
